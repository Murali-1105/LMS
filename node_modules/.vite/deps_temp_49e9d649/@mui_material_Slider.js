...
} from "./chunk-43INMOH4.js";
import {
  _extends,
  init_extends
} from "./chunk-PCRG5TTY.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-IZ6XXAT5.js";
import {
  require_jsx_runtime
} from "./chunk-FSQZUTP2.js";
import {
  require_prop_types
} from "./chunk-UFLCRKOV.js";
import "./chunk-ER4HESO3.js";
import {
  require_react
} from "./chunk-QCUIVNLQ.js";
import {
  __commonJS,
  __esm,
  __export,
...
var React17, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, isDevelopment4, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? (0, import_jsx_runtime2.jsx)(CacheProvider, {
    value: cache,
    children
  }) : children;
}
var React18, import_prop_types7, import_jsx_runtime2, cache;
...
function GlobalStyles(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(Global, {
    styles: globalStyles
  });
}
var React19, import_prop_types8, import_jsx_runtime3;
...
function useSlider(parameters) {
  ...
  const touchId = React13.useRef();
  const [active, setActive] = React13.useState(-1);
  const [open, setOpen] = React13.useState(-1);
  const [dragging, setDragging] = React13.useState(false);
  const moveCount = React13.useRef(0);
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React13.useState(-1);
  const sliderRef = React13.useRef();
  ...
  const previousIndex = React13.useRef();
  ...
  const stopListening = React13.useCallback(() => {
    const doc = ownerDocument(sliderRef.current);
...
function DefaultPropsProvider({
  ...
  return (0, import_jsx_runtime4.jsx)(PropsContext.Provider, {
    value,
    children
  });
}
...
function DefaultPropsProvider2(props) {
  return (0, import_jsx_runtime5.jsx)(DefaultPropsProvider_default, _extends({}, props));
}
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime7.jsxs)(React23.Fragment, {
...
var Slider = React24.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime8.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime8.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime9.jsxs)(React24.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(MarkSlot, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime8.jsx)(MarkLabelSlot, _extends({
          "aria-hidden": true,
          "data-index": index
      ...
      return (
        ...
        (0, import_jsx_runtime8.jsx)(ValueLabelComponent, _extends({}, !isHostComponent_default(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          children: (0, import_jsx_runtime8.jsx)(ThumbSlot, _extends({
            "data-index": index
          }, thumbProps, {
            ...
            children: (0, import_jsx_runtime8.jsx)(InputSlot, _extends({
              "data-index": index,
...
true ? Slider.propTypes = {
  ...
  componentsProps: import_prop_types12.default.shape({
    ...
    mark: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    markLabel: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    rail: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    root: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    thumb: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    track: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    valueLabel: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.shape({
      children: import_prop_types12.default.element,
      className: import_prop_types12.default.string,
   ...
   * @default 10
   */
  shiftStep: import_prop_types12.default.number,
  /**
