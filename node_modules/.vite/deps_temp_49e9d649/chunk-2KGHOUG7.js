...
function ThemeProvider({
  ...
  return (0, import_jsx_runtime8.jsx)(Provider, {
    value: contextValue,
    children
  });
}
...
var ModalDialog = React12.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React13.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var ModalHeader = React16.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React18.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React19.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react22.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react22.useState)(false);
  const waitingForMouseUpRef = (0, import_react22.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react22.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react22.useRef)(null);
  ...
  const renderBackdrop = (0, import_react22.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime18.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime18.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-2KGHOUG7.js.map
