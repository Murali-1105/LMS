                ...
                <li className="nav-profile">  
                  <div className='dropdown'>
                   ...
                   <div className="dropdown-menu dropdown-menu-end mt-4 p-3 border">
                        <Link to={`/student/profile/`} className="dropdown-item"><i className="bi bi-person-fill fs-5 pe-2"></i>Profile</Link>
                        <Link to={`/student/change-password/`} className="dropdown-item"><i class="bi bi-key-fill fs-5 pe-2"></i>Reset Password</Link> 
                        <hr className='my-2'/>
